  ...
  const fetchInterViewStatus = async () => {
    try {
      ...
      // Adjust based on your API response structure
        ...
        setInterViewStatusDetails(response.data.jobInterview);
        setLoading(false);
     
    } catch (err) {
      console.error("Error fetching interview status:", err);
      setErrors("Failed to fetch interview status.");
      setLoading(false);
      setInterViewStatusDetails([]);
    }
  };
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      if (err.response && err.response.data && err.response.data.errors) {
        ...
        toast.error("Failed to create interview status.");
      }
    }
  };
        ...
        axios
          ...
          .then((response) => {
            if (response.data) {
              ...
              Swal.fire("Error!", "Failed to delete interview status.", "error");
            }
          })
          .catch((error) => {
            console.error("Error deleting interview status:", error);
            Swal.fire("Error!", "Failed to delete interview status.", "error");
          });
      }
    });
    ...
    <div className="flex flex-col justify-between bg-gray-100 w-screen min-h-screen px-3 md:px-5 pt-2 md:pt-10">
      {loading ? (
        ...
        <div className="flex justify-between mt-8">
          <div className="">
            <h1 className="text-2xl md:text-3xl font-semibold">Interview Status</h1>
          </div>
...
export default InterViewStatus_Details;