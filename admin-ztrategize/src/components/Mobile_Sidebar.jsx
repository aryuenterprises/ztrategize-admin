                ...
                <div className="flex flex-col gap-1 mt-3 px-4">
                  ...
                  {openSection === "onboarding" && (
                    ...
                    >
                      <div className="flex gap-2 w-full h-full items-start  ms-10 flex-col text-sm font-medium text-gray-500">
                        ...
                        <button
                          onClick={() => onClickSidebarMenu("releiving-letter")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Relieving List
                        </button>
                  ...
                  {openSection === "finance" && (
                    ...
                    >
                      <div className="flex gap-2  items-start  ms-10 flex-col text-sm font-medium text-gray-500">
                        <button
                          onClick={() => onClickSidebarMenu("finance-account")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Account
                        </button>
                        <button
                          onClick={() => onClickSidebarMenu("income/details")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Income List
                        </button>
                        <button
                          onClick={() => onClickSidebarMenu("expense/details")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Expense List
                        </button>
                  ...
                  {openSection === "bidding" && (
                    ...
                    >
                      <div className="flex gap-2  items-start  ms-10 flex-col text-sm font-medium text-gray-500">
                        <button
                          onClick={() => onClickSidebarMenu("account-bidding")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Account
                        </button>
                        ...
                        <button
                          onClick={() => onClickSidebarMenu("bidding-details")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Bidding Details
                        </button>
                        <button
                          onClick={() => onClickSidebarMenu("connect-details")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Connects Details
                        </button>
                        <button
                          onClick={() => onClickSidebarMenu("bidding-reports")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Bidding Reports
                        </button>
                  ...
                  {openSection === "socialmedia" && (
                    ...
                    >
                      <div className="flex gap-2  items-start  ms-10 flex-col text-sm font-medium text-gray-500">
                        <button
                          onClick={() => onClickSidebarMenu("social-account")}
                          className="hover:bg-blue-100 px-2 py-1 rounded-full"
                        >
                          Social Account
                        </button>
