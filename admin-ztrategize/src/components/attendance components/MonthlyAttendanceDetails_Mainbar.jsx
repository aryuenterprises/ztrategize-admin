    ...
    <div className="flex flex-col justify-between overflow-x-hidden bg-gray-100 min-h-screen px-5 pt-2 md:pt-5 w-screen ">
      {loading ? (
        ...
        <div
          ...
          style={{
            top:
              tooltipData.y + 10 + 200 > window.innerHeight // 200 = approx tooltip height
                ? tooltipData.y - 200
                : tooltipData.y + 10,
            left:
              tooltipData.x + 10 + 250 > window.innerWidth // 250 = approx tooltip width
                ? tooltipData.x - 250
                : tooltipData.x + 10,
            maxWidth: "250px", // prevent too wide
            maxHeight: "auto", // prevent too tall
          }}
        >
          <div>
