    ...
    <div className="flex">
      {loading ? (
        ...
        <>
          ...
          <div
            className="absolute bg-[#fafafa] border border-gray-300 shadow-lg px-5 py-5 rounded text-xs z-50 max-h-[180px] overflow-y-auto"
            style={{
          ...
          >
              ...
              {tooltipData?.data?.map((data, index) => (
                <div className=" ">
                  <div className="mt-2 flex items-center text-[16px] justify-between gap-4">
                    <h2 className="text-[16px] ">{data?.status}</h2>
            ...
            {tooltipData?.data?.length > 0 && (
              ...
              >
                {tooltipData.data.map((data, index) => (
                  ...
                  >
                    <h2 className="text-[16px] font-medium text-gray-800">{data?.status}</h2>
                    <p className="text-gray-700">{data?.date}</p>
                  </div>
                ))}
              </div>
            ...
            {permissionTooltipData?.data.length > 0 && (
              <div
                ...
                style={{
                  ...
                  left: permissionTooltipData.x - 80,
                }}
                onMouseLeave={() => setTooltipData(null)}
              >
                <div className="">
                  {permissionTooltipData?.data?.map((data, index) => (
                    <div className=" ">
                      <div className="mt-2 flex items-center text-[16px] justify-between gap-4">
                        <h2 className="text-[16px] ">{data?.status}</h2>
                        <p className="text-gray-700">{data?.date}</p>
            ...
            {/* //  Tooltip Renderer (place it outside your DataTable JSX) */}
            {permissionTooltipData?.data?.length > 0 && (
              <div
                ...
                onMouseEnter={() =>
                  setPermissionTooltipData((prev) => ({ ...prev, isHoveringTooltip: true }))
                }
              ...
              >
                {permissionTooltipData.data.map((item, index) => (
                  ...
                  >
                    <h2 className="font-medium text-gray-800">{item?.status}</h2>
