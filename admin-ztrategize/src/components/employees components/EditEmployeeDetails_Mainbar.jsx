...
const EditEmployeeDetails_Mainbar = () => {
  ...
  const handleSubmit = async (id) => {
    ...
    const isuanNumber = formData?.uanNo.toString().trim().length <= 12 ? true : false;
                  ...
                  <div className="flex flex-col gap-4 mt-4">
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <input
                        ...
                        className={`border-2 rounded-xl px-4 h-10 outline-none w-full  lg:w-72 ${!touched.fullName
                          ? "border-red-400"
                          : "border-gray-300"
                          }`}
                        onKeyUp={handleKeyUp}
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <div className="flex gap-1 w-full flex-col  lg:w-72">
                        <input
                          ...
                          className={`border-2 rounded-xl px-4 h-10 outline-none w-full lg:w-72 ${!touched.phoneNum
                            ? "border-red-400"
                            : "border-gray-300"
                            }`}
                          onKeyUp={handleKeyUp}
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <input
                        ...
                        className={`border-2 rounded-xl px-4 h-10 outline-none w-full lg:w-72 ${!touched.email ? "border-red-400" : "border-gray-300"
                          }`}
                        onKeyUp={handleKeyUp}
                      />
                    </div>
        ...
        /> */}
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <div className="relative">
                        <DatePicker
                          ...
                          className={`border-2 rounded-xl h-10 px-4  outline-none w-full lg:w-72 ${!touched.dateOfJoin
                            ? "border-red-400"
                            : "border-gray-300"
                            }`}
                          onKeyUp={handleKeyUp}
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <input
                        ...
                        className={`border-2 rounded-xl px-4 h-10 outline-none w-full  lg:w-72 ${!touched.employeeId
                          ? "border-red-400"
                          : "border-gray-300"
                          }`}
                        onKeyUp={handleKeyUp}
                      ...
                      <div className="flex flex-col xl:flex-row gap-1 justify-between  ">
                        ...
                        <div>
                          <DatePicker
                            ...
                            className={`border-2 rounded-xl h-10 px-4  outline-none w-full lg:w-72 ${!touched.relivingdate
                              ? "border-red-400"
                              : "border-gray-300"
                              }`}
                            onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col gap-4 mt-4" id="personal-info">
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <input
                        ...
                        className={`border-2 h-10 rounded-xl px-4  outline-none w-full  lg:w-72 ${!touched.passportNo
                          ? "border-red-400"
                          : "border-gray-300"
                          }`}
                        onKeyUp={handleKeyUp}
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <div className="relative">
                        <input
                          type="text"
                          className={`border-2 rounded-xl [&::-webkit-inner-spin-button]:appearance-none h-10 px-4 border-gray-300 outline-none w-full lg:w-72  ${!touched.panNo
                            ? "border-red-400"
                            : "border-gray-300"
                            }`}
                          onKeyUp={handleKeyUp}
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <input
                        ...
                        onKeyUp={handleKeyUp}
                        className={`border-2 h-10 [&::-webkit-inner-spin-button]:appearance-none rounded-xl px-4 border-gray-300 outline-none w-full  lg:w-72  ${!touched.aadharNo
                          ? "border-red-400"
                          : "border-gray-300"
                          }`}
                      />
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-1">
                      ...
                      <div className="relative">
                        <DatePicker
                          ...
                          className={`border-2 rounded-xl h-10 px-4 border-gray-300 outline-none w-full lg:w-72 ${!touched.dob ? "border-red-400" : "border-gray-300"
                            }`}
                          onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col gap-4 mt-4">
                    <div className="flex flex-col xl:flex-row gap-1 justify-between  ">
                      ...
                      <input
                        ...
                        className={`border-2 rounded-xl px-4  outline-none h-10 w-full  lg:w-72 ${!touched.emergencyName
                          ? "border-red-400 "
                          : "border-gray-300"
                          }`}
                        onKeyUp={handleKeyUp}
                    ...
                    <div className="flex flex-col xl:flex-row gap-1 justify-between  ">
                      ...
                      <div className="flex flex-col">
                        <input
                          ...
                          className={`border-2 rounded-xl px-4 border-gray-300 outline-none h-10 w-full  lg:w-72 ${!touched.emergencyContact
                            ? "border-red-400 "
                            : "border-gray-300"
                            }`}
                          onKeyUp={handleKeyUp}
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 mt-4">
                    <div className="flex flex-col xl:flex-row gap-1 justify-between  ">
                      ...
                      <div className="flex flex-col justify-end">
                        <input
                          ...
                          className={`border-2 h-10 lg:w-52 rounded-xl px-4 border-gray-300 outline-none w-full   ${!touched.accountNumber
                            ? "border-red-400 "
                            : "border-gray-300"
                            }`}
                          onKeyUp={handleKeyUp}
                    ...
                    <div className="flex flex-col xl:flex-row gap-1 justify-between  ">
                      ...
                      <div
                        className={`relative w-full lg:w-52 border-2 rounded-xl px-4 border-gray-300 outline-none ${!touched.BankName
                          ? "border-red-400 "
                          : "border-gray-300"
                          }`}
                      >
                        <button
                          ...
                          className={`w-full ${selectedBankNameOption
                            ? "text-black"
                            : "text-gray-400"
                            } py-2 text-left bg-white  rounded-lg shadow-sm focus:outline-none`}
                        >
                    ...
                    <div className="flex flex-col xl:flex-row gap-1 justify-between  ">
                      ...
                      <input
                        ...
                        className={`border-2 rounded-xl h-10 px-4 w-full lg:w-52  outline-none ${!touched.accountbranch
                          ? "border-red-400 "
                          : "border-gray-300"
                          }`}
                        onKeyUp={handleKeyUp}
                    ...
                    <div className="flex flex-col xl:flex-row gap-1 justify-between  ">
                      ...
                      <input
                        ...
                        className={`border-2 rounded-xl h-10 px-4 w-full lg:w-52 border-gray-300 outline-none  ${!touched.ifscCode
                          ? "border-red-400 "
                          : "border-gray-300"
                          }`}
                        onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col gap-3 mt-4">
                    ...
                    <div className="flex flex-col xl:flex-row gap-1 justify-between  ">
                      ...
                      <input
                        ...
                        className={`border-2 rounded-xl px-4 h-10 border-gray-300 outline-none w-full lg:w-52 ${!touched.salaryAmount
                          ? "border-red-400 "
                          : "border-gray-300"
                          }`}
                      />
                  ...
                  /> */}
                    ...
                    <div className="flex flex-col xl:flex-row justify-between">
                      ...
                      <select
                        ...
                        className={`border-2 rounded-xl px-4 h-10 outline-none w-full lg:w-52 ${!touched.PaymentType
                          ? "border-red-400"
                          : "border-gray-300"
                          }`}
                        onChange={(e) =>
                  ...
                  <div className="flex flex-col gap-3 mt-4">
                    ...
                    <div className="flex flex-col xl:flex-row gap-1 justify-between">
                      ...
                      <div className="relative border-2 rounded-xl px-4 border-gray-300 w-full lg:w-52">
                        <button
                          onClick={() => setDurationIsOpen(!durationIsOpen)}
                          className={`w-full ${selectedDuration ? "text-black" : "text-gray-400"
                            } py-2 text-left bg-white rounded-lg shadow-sm focus:outline-none`}
                        >
                ...
                <div className="flex flex-col gap-3 mt-8">
                  <div className="flex flex-col lg:flex-row gap-1 justify-between">
                    ...
                    <input
                      ...
                      className={` border-2 rounded-xl px-4 py-2 h-10 outline-none w-full md:w-96  ${!expTouched.jobTitle
                        ? "border-red-400"
                        : "border-gray-300 "
                        }`}
                      onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col lg:flex-row gap-1 justify-between">
                    ...
                    <input
                      ...
                      className={`border-2 rounded-xl px-4 h-10 border-gray-300 outline-none w-full md:w-96 ${!expTouched.companyIndustry
                        ? "border-red-400"
                        : "border-gray-300 "
                        }`}
                      onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col lg:flex-row gap-1 justify-between">
                    ...
                    <input
                      ...
                      className={`border-2 rounded-xl px-4 h-10 border-gray-300 outline-none w-full md:w-96 ${!expTouched.companyName
                        ? "border-red-400"
                        : "border-gray-300 "
                        }`}
                      onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col lg:flex-row gap-1 justify-between">
                    ...
                    <input
                      ...
                      className={`border-2 rounded-xl px-4 h-10 border-gray-300 outline-none w-full md:w-96 ${!expTouched.previousSalary
                        ? "border-red-400"
                        : "border-gray-300 "
                        }`}
                      onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col lg:flex-row gap-1 justify-between">
                    ...
                    <div className="flex flex-col md:flex-row flex-wrap gap-3 w-full md:w-96 overflow-hidden">
                      <DatePicker
                        ...
                        className={`border-2  rounded-xl w-full md:w-44 h-10 px-4 border-gray-300 outline-none ${!expTouched.startWork
                          ? "border-red-400"
                          : "border-gray-300 "
                          }`}
                        onKeyUp={handleKeyUp}
                      ...
                      <DatePicker
                        ...
                        className={`border-2 rounded-xl h-10 px-4 w-full md:w-44 border-gray-300 outline-none ${!expTouched.startWork
                          ? "border-red-400"
                          : "border-gray-300 "
                          }`}
                        onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col lg:flex-row gap-1 justify-between">
                    ...
                    <textarea
                      ...
                      rows="3"
                      className={`  w-full md:w-96 pt-2 rounded-xl px-4   border-2 outline-none ${!expTouched.responsibilities
                        ? "border-red-400"
                        : "border-gray-300 "
                        }`}
                      onKeyUp={handleKeyUp}
                ...
                <div className="flex flex-col gap-3 mt-8">
                  ...
                  <div className="flex flex-col lg:flex-row gap-1 justify-between">
                    ...
                    <input
                      ...
                      className={`border-2 rounded-xl px-4 py-2  outline-none h-10 w-full md:w-96 ${!educationTouched.SchoolName
                        ? "border-red-400"
                        : "border gray-300"
                        }`}
                      onKeyUp={handleKeyUp}
                  ...
                  <div className="flex flex-col lg:flex-row gap-1 justify-between">
                    ...
                    <input
                      ...
                      className={`border-2 rounded-xl px-4 py-2  outline-none h-10 w-full md:w-96 ${!educationTouched.DepartmentName
                        ? "border-red-400"
                        : "border-gray-300"
                        }`}
                      onKeyUp={handleKeyUp}
                  ...
                  /> */}
                      <input
                        ...
                        className={`border-2 rounded-xl px-4 py-2 outline-none w-full ${!educationTouched.YearOfPassing
                          ? "border-red-400"
                          : "border-gray-300"
                          }`}
                        onKeyUp={handleKeyUp}
              ...
              >
                ...
                <div className="flex flex-col lg:flex-row gap-1  justify-between mt-8">
                  ...
                  <input
                    ...
                    className={`border-2 rounded-xl px-4 py-2  outline-none w-full md:w-96 ${!docTitle ? "border-red-400" : "border-gray-300"
                      }`}
                    onKeyUp={handleKeyUp}
                  />
                </div>
