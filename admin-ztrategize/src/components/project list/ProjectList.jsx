...
const ProjectList = () => {
  ...
  const openEditModal = (
    ...
    // console.log("hhhhh", projectDescription);
    setRoleDetails({
      name,
      status,
      id,
    ...
    <div className="flex flex-col justify-between bg-gray-100 w-screen min-h-screen px-3 md:px-5 pt-2 md:pt-10">
      ...
      <div>
        ...
        <div className="flex justify-between mt-8 mb-3">
          <h1 className="text-2xl md:text-3xl font-semibold">Project List</h1>
          <button
                          ...
                          <div className="flex gap-6">
                            ...
                            <label className="flex items-center gap-1 cursor-pointer">
                              <input
                                ...
                                name="gstOption"
                                value="without_gst"
                                checked={roleDetails.gstType === "without_gst"}
                                onChange={(e) =>
                                  setRoleDetails((row) => ({
                                    ...row,
                                    gstType: e.target.value,
                          ...
                          <div className="flex items-center gap-6 mb-4">
                            <label className="flex items-center gap-2 cursor-pointer">
                              <input
                                ...
                                name="paymentType"
                                value="one-time"
                                checked={roleDetails.paymentType === "one-time"}
                                onChange={(e) =>
                                  setRoleDetails({
                                    ...roleDetails,
