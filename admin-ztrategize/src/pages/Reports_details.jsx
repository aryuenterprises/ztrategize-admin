                              ...
                              {filteredTaskList.map((day) => {
                                ...
                                return day.tasks.length > 0 ? (
                                  day.tasks.map((task, taskIndex) => (
                                    ...
                                    >
                                      {/* Date cell - only once per day */}
                                      {taskIndex === 0 && (
                                        <td
                                          rowSpan={rowSpan}
                                          className="px-4 py-4 md:sticky left-0 bg-gray-50 border-r border-gray-200 align-top z-10"
                                        >
                                          <div className="flex flex-col items-center justify-center p-3 rounded-lg shadow-sm bg-white border border-gray-200">
                                            ...
                                            {/* Date */}
                                            <div className="text-sm font-semibold text-white px-3 py-1 rounded-full bg-gradient-to-r from-blue-500 to-blue-400 shadow">
                                              {new Date(
                                                day.date
                                      ...
                                      <td
                                        ...
                                        onClick={() => onClickCard(task.taskId)}
                                      >
                                        #{task.taskId}
                                      </td>
                                      ...
                                      <td className="py-4 w-[100px]">
                                        <span
                                          className={`px-3 py-1 text-xs w-f font-bold rounded-full shadow-sm ${
                                            task.status === "done"
                                      ...
                                      >
                                        {task.totalDuration.hours}h{" "}
                                        {task.totalDuration.minutes}m{" "}
                                        {task.totalDuration.seconds}s
                                      </td>
                                      ...
                                      >
                                        {task.totalDurationTester.hours}h{" "}
                                        {task.totalDurationTester.minutes}m{" "}
                                        {task.totalDurationTester.seconds}s

                                      </td>
                                    </tr>
                                  ))
                                ) : (
                                  <tr key={day.date} className="bg-gray-50">
                                    <td className="px-4 py-4 md:sticky left-0 bg-gray-50 border-r border-gray-200 z-10">
                                      <div className="flex flex-col items-center justify-center p-3 rounded-lg shadow-sm bg-white border border-gray-200">
                                        <div className="text-lg font-bold text-blue-700 mb-1">
                                          {day.dayName}
                                        </div>
